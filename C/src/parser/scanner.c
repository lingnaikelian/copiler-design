...
int yylex() {
    ...
    // Set location for Bison's @N.first_line tracking
    yylloc.first_line = yylloc.last_line = currentToken.line;
    yylloc.first_column = yylloc.last_column = currentToken.column;
